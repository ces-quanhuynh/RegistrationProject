...
/**
 * Provides the local service interface for UserEntry. Methods of this
...
public interface UserEntryLocalService
	...
	public UserEntry createUserEntry(long userEntryId);
	...
	public UserEntry deleteUserEntry(long userEntryId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public UserEntry deleteUserEntry(UserEntry userEntry);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserEntry fetchUserEntry(long userEntryId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserEntry> getUserEntries(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserEntry getUserEntry(long userEntryId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserEntry updateUserEntry(UserEntry userEntry);
