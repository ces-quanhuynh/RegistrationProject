...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=" + MVCCommandNames.VIEW_LOGIN_AUDIT_EVENT,
                //"mvc.command.name=/"
        },
        service = MVCRenderCommand.class
)
public class ViewLoginAuditEventMVCRenderCommand implements MVCRenderCommand{
    @Override
    public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
        return "/adminmonitor/view_login.jsp";
    }
}
